...
| 📡 **Activity Dashboard** | Live kanban of every task your agents are working on — Active, Completed, Errors — with drill-down to every tool call. Admins see everything; editors see only agents they own or are granted access to; viewers are blocked. |
