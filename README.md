...
### Step 1 — Identity
Set the agent's name, slug (e.g., `gilfoyle`), persona, and description. The description is used by the Boss for delegation decisions.
...
Boss:     I'll get @gilfoyle on this 👇
          @gilfoyle — user wants booking analysis for last week
Gilfoyle: [reads full thread, runs Redshift query via MCP]
...
[![Star History Chart](https://api.star-history.com/svg?repos=amansrivastava17/slack-claude-code-agent-team&type=Date)](https://star-history.com/#amansrivastava17/slack-claude-code-agent-team&Date)
