...
export async function init(opts: InitOptions): Promise<void> {
  ...
  console.log('');
  console.log(chalk.bold('  🐝 SlackHive Setup'));
  console.log(chalk.gray('  Build, deploy, and orchestrate AI agent teams on Slack'));
  console.log('');
  ...
  // ── Done ───────────────────────────────────────────────────────────────────
  console.log('');
  console.log(chalk.bold.green('  ✅ SlackHive is ready!'));
  console.log('');
